...
library AssertBytes {
    ...
    */
    ...
    function notEqual(bytes memory _a, bytes memory _b) internal pure returns (bool) {
        return !_equal(_a, _b);
    }
    ...
    */
    ...
    function equal_nonAligned(bytes memory _a, bytes memory _b) internal pure returns (bool) {
        return _equal_nonAligned(_a, _b);
    }

    function notEqual_nonAligned(bytes memory _a, bytes memory _b) internal pure returns (bool) {
        return !_equal_nonAligned(_a, _b);
    }
    ...
    */
    ...
    function equalStorage(bytes storage _a, bytes memory _b) internal view returns (bool) {
        return _equalStorage(_a, _b);
    }

    function notEqualStorage(bytes storage _a, bytes memory _b) internal view returns (bool) {
        return !_equalStorage(_a, _b);
    }
}
